...
from hidisc.datasets.srh_dataset import OpenSRHDataset
from hidisc.datasets.improc import get_srh_base_aug, get_srh_vit_base_aug
from hidisc.train.common import (parse_args, get_exp_name, config_loggers,
                                 get_num_worker)
from hidisc.train.train_hidisc import HiDiscSystem
...
def get_embeddings(cf: Dict[str, Any],
    ...
    print(train_predictions["embeddings"].shape)
    print(train_predictions["label"].shape)
